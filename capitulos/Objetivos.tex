...
Con 300~horas de dedicación había que acotar el alcance desde el principio. \textbf{Se incluye}:
...
\begin{itemize}
    ...
    \item \textbf{Comprobación cruzada metodológica.} El análisis se repite con un segundo mecanismo de degradación, independiente de la acumulación real. Si el ranking coincide, no es un artefacto del mecanismo.
